...
/**
 * The PeerLogger class is responsible for logging various events in a peer-to-peer network.
 */
public class DataLogger {
    ...
    public DataLogger(String peerId) {
        this.peerID = peerId;
        this.logFilePath = "~/project/log_peer_" + peerId + ".log";
    }
     ...
     *
     * @param optimisticUnchokedNeighborID The ID of the optimistically unchoked neighbor.
     */
     ...
     *
     * @param senderPeerID The ID of the peer that sent the 'not interested' message.
     */
